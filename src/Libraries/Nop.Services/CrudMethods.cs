...
{
    /// <summary>
    /// Represents the default CRUD methods implementation
    /// </summary>
    /// <typeparam name="TEntity"></typeparam>
    public partial class CrudMethods<TEntity> : ICrudMethods<TEntity>
        where TEntity : BaseEntity
    {
        protected readonly IEventPublisher _eventPublisher;
        protected readonly IRepository<TEntity> _repository;

        protected CrudMethods(IEventPublisher eventPublisher, IRepository<TEntity> repository)
        {
        ...
        public virtual void Delete(TEntity entity)
        {
            ...
            if (entity is INotDeletedEntity notDeleted)
                notDeleted.Deleted = true;
            else
